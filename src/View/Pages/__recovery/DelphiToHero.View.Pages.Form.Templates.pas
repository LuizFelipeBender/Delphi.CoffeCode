...
uses
  ...
  Vcl.StdCtrls, Vcl.Buttons, System.ImageList, System.json, Vcl.ImgList, Bind4D, Vcl.Imaging.pngimage;
...
uses DelphiToHero.View.Pages.Usuarios,
...
begin
property name: type read Fname write Fname;
